...
ADMIN_ACCOUNT_LEVEL_COLOR_PALETTES_KEY = 'AccountLevelColorPalettes'
ADMIN_ACCOUNT_LEVEL_THEMES_KEY = 'AccountLevelThemes'
ADMIN_SPACE_LEVEL_COLOR_PALETTES_KEY = 'SpaceLevelColorPalettes'
ADMIN_SPACE_LEVEL_THEME_KEY = 'SpaceTheme'
...
repo_download_upload_def = {
    ...
    ADMIN_ACCOUNT_LEVEL_COLOR_PALETTES_KEY: [
        'account_level_color_palettes.json',
        'GetAccountLevelColorPalettes',
        '',
        '',
        '',
        'application/json',
    ...
    ADMIN_ACCOUNT_LEVEL_THEMES_KEY: [
        'account_level_themes.json',
        'GetAccountLevelThemes',
        '',
        '',
        '',
        'application/json',
    ...
    ADMIN_SPACE_LEVEL_COLOR_PALETTES_KEY: [
        'space_level_color_palettes.json',
        'GetSpaceLevelColorPalettes',
        '',
        '',
        '',
        'application/json',
    ...
    ADMIN_SPACE_LEVEL_THEME_KEY: [
        'space_level_theme.json',
        'GetSpaceTheme',
        '',
        '',
        '',
    ...
    if not result[2]:
        ...
        if not event_targets_not_defined:
            ...
            for event_target in event_targets.keys():
                ...
                # Main code for downloading repo files
...
def admin_get_staging_table(soap_session, space_name, space_id, source_name):
    ...
    if not error:
        ...
        if not error:
            do_not_proc = \
                response_post.text.partition('<' + DONOTPROCESS + '>')[2].partition('</' + DONOTPROCESS + '>')[
                    0].strip()
            processing_groups = \
...
def get_copy_from_to_spaces(copy_config, current_date_time, array_of_spaces):
    ...
    if not error:
        ...
        for space in copy_config[SPACE_COPY_FROM_SPACES]:
            ...
            if SPACE_COPY_FROM in copy_config.keys() and copy_config[SPACE_COPY_FROM]:
                copy_from_name = copy_config[SPACE_COPY_FROM] + '_' + space
            else:
                copy_from_name = space
